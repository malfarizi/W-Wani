        ...
        <form action="{{url('registerPost')}}" method="post" role="form" class="button-register"
            ...
            <div class=" form-group">
                ...
                <select class="select2-single-placeholder form-control" name="nama_bank" id="nama_bank"
                    ...
                    <option value="The Hongkong & Shanghai B.C. (Bank HSBC)">The Hongkong & Shanghai B.C. (Bank HSBC)
                    </option>
            ...
            <div class=" form-group">
                ...
                <select class="select2-single-placeholder form-control" name="id_kota" id="id_kota" style="width: 100%">
                    <option value="">Select</option>
