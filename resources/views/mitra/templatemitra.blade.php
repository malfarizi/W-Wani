...
<body id="page-top">
    <div id="wrapper">
        ...
        <ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap-produk"
                    aria-expanded="true" aria-controls="collapseBootstrap">
                    <i class="fas fa-store"></i>
                    <span>Produk</span>
                </a>
                <div id="collapseBootstrap-produk" class="collapse" aria-labelledby="headingBootstrap"
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseBootstrap-alat"
                    aria-expanded="true" aria-controls="collapseBootstrap">
                    <i class="fas fa-tools"></i>
                    <span>Alat Tani</span>
                </a>
                <div id="collapseBootstrap-alat" class="collapse" aria-labelledby="headingBootstrap"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
            ...
            <li class="nav-item">
                ...
                <div id="collapseBootstrap-alattani" class="collapse" aria-labelledby="headingBootstrap"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
