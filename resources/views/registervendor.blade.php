  ...
  <div class="container">
    ...
    <div class="row mt-5">
      ...
      <div class="col-lg-8 mt-5 mt-lg-0">
        ...
        <form action="{{url('registerPostVendor')}}" method="post" role="form" class="button-register" enctype="multipart/form-data">
          @csrf
          ...
          <div class=" form-group">
            <label for="nama_bank">Nama Bank</label>
                ...
                name="nama_bank" id="nama_bank" style="width: 100%">
              ...
              <option value="The Hongkong & Shanghai B.C. (Bank HSBC)">The Hongkong & Shanghai B.C. (Bank HSBC) </option>                 
              ...
              <option value="Bank Metro Express (Bank Shinhan Indonesia)">Bank Metro Express (Bank Shinhan Indonesia) </option>                 
